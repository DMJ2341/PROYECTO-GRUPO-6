...
val CardBg = Color(0xFF1E293B)         // Fondo de tarjetas
...
// Colores de estado
val Success = Color(0xFF4ADE80)    // Verde
val Warning = Color(0xFFFACC15)    // Amarillo (para Racha)
val Danger = Color(0xFFF7556C)       // Rojo (para Logout)